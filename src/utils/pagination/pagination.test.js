...
test('pagination({ total: 5, active: 1}) should return [1, 2, 3, 4, 5]', () => {
  const params = { total: 5, activePage: 1 }
  const result = [1, 2, 3, 4, 5]
  expect(pagination(params)).to.be.deep.equal(result)
})
test('pagination({ total: 6, active: 1 }) should return [1, 2, 3, "...", 6]', () => {
  const params = { total: 6, activePage: 1 }
  const result = [1, 2, 3, '...', 6]
  expect(pagination(params)).to.be.deep.equal(result)
})
test('pagination({ total: 6, active: 2 }) should return [1, 2, 3, "...", 6]', () => {
  const params = { total: 6, activePage: 2 }
  const result = [1, 2, 3, '...', 6]
  expect(pagination(params)).to.be.deep.equal(result)
})
test('pagination({ total: 6, active: 3 }) should return [1, 2, 3, 4, 5, 6]', () => {
  const params = { total: 6, activePage: 3 }
  const result = [1, 2, 3, 4, 5, 6]
  expect(pagination(params)).to.be.deep.equal(result)
})
test('pagination({ total: 6, active: 4 }) should return [1, 2, 3, 4, 5, 6]', () => {
...
test('pagination({ total: 7, active: 4 }) should return [1, 2, 3, 4, 5, 6, 7]', () => {
...
test('pagination({ total: 7, active: 7 }) should return [1, "...", 5, 6, 7]', () => {
  const params = { total: 7, activePage: 7 }
  const result = [1, '...', 5, 6, 7]
  expect(pagination(params)).to.be.deep.equal(result)
})
test('pagination({ total: 15, active: 8 }) should return [1, "...", 7, 8, 9, "...", 15]', () => {
...
test('pagination({ total: 10, activePage: "1a" }) should throw an error', () => {
  ...
  const result = 'activePage should be a number 1'
  try {
    pagination(params)
  } catch (e) {
    expect(e.message).to.be.equal(result)
